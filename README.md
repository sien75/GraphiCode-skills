...
This repository contains a series of AI skills for **GraphiCode**, an innovative programming tool that combines flowchart-driven logic with large language model code generation.

These skills empower the coding agent to initialize, scaffold, and manage GraphiCode projects across various technology stacks (e.g., TypeScript with Bun or Umi).
